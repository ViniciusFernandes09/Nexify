                                ...
                                <div className="nxf-cart-item-left">
                                    ...
                                    <div className="nxf-cart-item-description">
                                        ...
                                        <div className="nxf-cart-item-quantity-container">
                                            <div onClick = {() => handleDecreaseItem(item.productId)} className="nxf-cart-item-quantity-btn">-</div>
                                            <p>{item.quantity}</p>
                                            <div onClick = {() => handleIncreaseItem(item.productId)} className="nxf-cart-item-quantity-btn">+</div>
                                        </div>
                                    </div>
                                </div>
